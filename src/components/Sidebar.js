...
import { FaHome, FaUserFriends, FaCalendarAlt, FaFileAlt, FaCog, FaTv, FaFileUpload, FaClipboardList, FaBars, FaTimes } from 'react-icons/fa';
    ...
    <>
      ...
      <div className={`fixed top-0 left-0 h-screen 
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <Link to="/view-documents" className={linkClasses} onClick={() => setIsOpen(false)}>
