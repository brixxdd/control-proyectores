...
import { Button } from 'react-bootstrap'; // Asegúrate de importar Button desde react-bootstrap
  ...
  return (
    <>
      ...
      <DeleteEventModal
        ...
        events={events.map(event => ({ ...event, toggleSelected: toggleEventSelection }))}
      />
    </>
  );
};
